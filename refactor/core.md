...
- **Environment Context**: Always set `export PYTHONPATH=/home/jwils/.gemini/antigravity/global_workflows/scripts`.
...
> See `global_workflows/scripts/README.md` for the full schema reference.
